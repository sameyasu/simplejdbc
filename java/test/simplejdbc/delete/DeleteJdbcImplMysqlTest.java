...
import simplejdbc.update.UpdateJdbcImplMysql;

/**
 * DeleteJdbcImplのテストクラス
 * @author yasu
 */
public class DeleteJdbcImplMysqlTest extends AbstractMysqlTestCase {
	...
	public void testDeleteByPrimaryKey3() throws SecurityException, NoSuchFieldException, SQLException, ParseException {
		...
		//更新後に取得した値と比較する
		selectJdbc = new SelectJdbcImplMysql<GoodsMstNoversion>(dbConnection, GoodsMstNoversion.class);
