 ...
 *
 */
public abstract class AbstractOracleTestCase extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		this.dbConnection = DriverManager.getConnection(
				bundle.getString("oracle.jdbc.url"),
				bundle.getString("oracle.db.user"),
				bundle.getString("oracle.db.password"));
