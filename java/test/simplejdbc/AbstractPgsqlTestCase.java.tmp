 ...
 *
 */
public abstract class AbstractPgsqlTestCase extends TestCase {
	...
	protected void setUp() throws Exception {
		...
		this.dbConnection = DriverManager.getConnection(
				bundle.getString("pgsql.jdbc.url"),
				bundle.getString("pgsql.db.user"),
				bundle.getString("pgsql.db.password"));
