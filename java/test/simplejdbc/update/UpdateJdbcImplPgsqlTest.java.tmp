...
/**
 * UpdateJdbcImplPgsqlのテストクラス
 * @author yasu
 */
public class UpdateJdbcImplPgsqlTest extends AbstractPgsqlTestCase {
	...
	public void testUpdateAllColumns() throws SecurityException, NoSuchFieldException, SQLException, ParseException {
		...
		entity.updateDate = null;	//NULLにアップデート
		entity.version = null;
	...
	public void testUpdateColums() throws SecurityException, NoSuchFieldException, SQLException, ParseException {
		...
		entity.registDate = null;	//NULLに設定
		entity.price = BigDecimal.valueOf(123.0);
		entity.version = null;

		assertEquals(1, updateJdbc.updateColumns(entity, "goodsName", "registDate", "updateDate", "price"));
		...
		assertEquals(entity.registDate, selectedEntity.registDate);
	}
	...
	public void testUpdateAllColumns2() throws SecurityException, NoSuchFieldException, SQLException, ParseException {
		...
		UpdateJdbcImplPgsql<GoodsMst> updateJdbc2 = new UpdateJdbcImplPgsql<GoodsMst>(dbConnection, GoodsMst.class);
		...
		UpdateJdbcImplPgsql<GoodsMst> updateJdbc3 = new UpdateJdbcImplPgsql<GoodsMst>(dbConnection, GoodsMst.class);
		//楽観的排他制御を無視
	...
	public void testUpdateAllColumns4() throws SecurityException, NoSuchFieldException, SQLException, ParseException {
		...
		UpdateJdbcImplPgsql<GoodsMstNoversion> updateJdbc = new UpdateJdbcImplPgsql<GoodsMstNoversion>(dbConnection, GoodsMstNoversion.class);
