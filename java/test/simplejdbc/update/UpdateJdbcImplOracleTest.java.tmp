...
/**
 * UpdateJdbcImplOracleのテストクラス
 * @author yasu
 */
public class UpdateJdbcImplOracleTest extends AbstractOracleTestCase {
	...
	public void testUpdateAllColumns() throws SecurityException, NoSuchFieldException, SQLException, ParseException {
		...
		UpdateJdbcImplOracle<GoodsMst> updateJdbc = new UpdateJdbcImplOracle<GoodsMst>(dbConnection, GoodsMst.class);
	...
	public void testUpdateAllColumns2() throws SecurityException, NoSuchFieldException, SQLException, ParseException {
		...
		UpdateJdbcImplOracle<GoodsMst> updateJdbc2 = new UpdateJdbcImplOracle<GoodsMst>(dbConnection, GoodsMst.class);
		...
		UpdateJdbcImplOracle<GoodsMst> updateJdbc3 = new UpdateJdbcImplOracle<GoodsMst>(dbConnection, GoodsMst.class);
		//楽観的排他制御を無視
	...
	public void testUpdateAllColumns4() throws SecurityException, NoSuchFieldException, SQLException, ParseException {
		...
		UpdateJdbcImplOracle<GoodsMstNoversion> updateJdbc = new UpdateJdbcImplOracle<GoodsMstNoversion>(dbConnection, GoodsMstNoversion.class);
