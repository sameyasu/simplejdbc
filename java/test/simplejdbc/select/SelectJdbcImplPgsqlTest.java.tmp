...
/**
 * SelectJdbcImplPgsqlのテストクラス
 * @author yasu
 */
public class SelectJdbcImplPgsqlTest extends AbstractPgsqlTestCase {
	...
	public void testSelectByPrimaryKey() throws SecurityException, NoSuchFieldException, SQLException, ParseException {
		...
		SelectJdbcImplPgsql<GoodsMstDualPrimaryKey> selectJdbc2 = new SelectJdbcImplPgsql<GoodsMstDualPrimaryKey>(dbConnection, GoodsMstDualPrimaryKey.class);
	...
	public void testAndWhere() throws SecurityException, NoSuchFieldException, SQLException, ParseException {
		...
		//該当レコードがない場合
		selectJdbc = new SelectJdbcImplPgsql<GoodsMst>(dbConnection, GoodsMst.class);
		selectJdbc.andWhere("GOODS_NAME = ?", nullObject);
	...
	public void testGetForUpdateSqlString() {
		...
		SelectJdbcImplPgsql<GoodsMst> selectJdbc2 = new SelectJdbcImplPgsql<GoodsMst>(dbConnection, GoodsMst.class);
	...
	public void testSelectByPrimaryKeyForUpdateNoWait() throws Exception {
		...
		try {
			...
			assertEquals("ERROR: リレーション\"goods_mst\"の行ロックを取得できませんでした", e.getMessage());
		}
	}
	...
	public void testSelectByPrimaryKeyForUpdateWait() throws Exception {
		...
		//別のコネクションから確認
		SelectJdbcImplPgsql<GoodsMst> selectJdbc2 = new SelectJdbcImplPgsql<GoodsMst>(dbConnection2, GoodsMst.class);
...
//			assertTrue(e instanceof SQLException);
//			assertEquals("ORA-30006",e.getMessage());
//		}
	}
...
//
//		protected SelectJdbcImplPgsql<GoodsMst> selectJdbc = null;
//
...
//			selectJdbc = new SelectJdbcImplPgsql<GoodsMst>(connection, GoodsMst.class);
