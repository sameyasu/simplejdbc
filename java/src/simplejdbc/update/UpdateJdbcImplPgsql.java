...
/**
 * UPDATE文サポートPgsql実装クラス
 * @author yasu
 * @param <E> エンティティクラス
 */
public class UpdateJdbcImplPgsql<E> extends AbstractManageVersionJdbc<E> implements UpdateJdbc<E> {

	/**
	 * ロガー
	 */
	private Log log = LogFactory.getLog(UpdateJdbcImplPgsql.class);
	 ...
	 */
	public UpdateJdbcImplPgsql(Connection connection, Class<E> clazz) {
