 ...
 * @param <E> エンティティクラス
 */
public class UpdateJdbcImplOracle<E> extends AbstractManageVersionJdbc<E> implements UpdateJdbc<E> {

	/**
	 * ロガー
	 */
	private Log log = LogFactory.getLog(UpdateJdbcImplOracle.class);
	 ...
	 */
	public UpdateJdbcImplOracle(Connection connection, Class<E> clazz) {
